        ...
        <div className="container-fluid bg-black" style={{marginTop: "100px", paddingTop: "100px"}}>
            <div className="row">
                <div className="col-md-12">
                    <a href="https://github.com/ZiddanDwiPutra/ny-times" className="fs-15">@ZiddanDwiPutra/ny-times - Github Repository</a>
                    <div className="fs-15">Credits</div>
                    <ul className="line-height-15">
                        <li><a href="https://www.freepik.com/vectors/welcome-party" className="fs-10">Welcome party vector created by storyset - www.freepik.com</a></li>
